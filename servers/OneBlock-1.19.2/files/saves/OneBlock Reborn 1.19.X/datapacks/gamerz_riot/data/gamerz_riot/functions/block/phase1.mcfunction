...
execute as @s[scores={gz-a4-riot=212,gz-a4-cool=1}] at @s align xz positioned ~0.5 ~ ~0.5 run function gamerz_riot:variants/sheep
...
execute as @s[scores={gz-a4-riot=266,gz-a4-cool=1}] at @s align xz positioned ~0.5 ~ ~0.5 run function gamerz_riot:mob/01-03-chicken
...
execute as @s[scores={gz-a4-riot=312,gz-a4-cool=1}] at @s align xz positioned ~0.5 ~ ~0.5 run function gamerz_riot:variants/sheep
